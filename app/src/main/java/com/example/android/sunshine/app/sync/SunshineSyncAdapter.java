...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
   ...
   private static final String[] WEAR_PROJECTION =
         new String[] { WeatherContract.WeatherEntry.COLUMN_WEATHER_ID,
               WeatherContract.WeatherEntry.COLUMN_MAX_TEMP,
               WeatherContract.WeatherEntry.COLUMN_MIN_TEMP };
   ...
   private WearConfig createWearConfig() {
      WearConfig wearConfig = new WearConfig();
      Context context = getContext();
...
//         }
         ...
         wearConfig.icon = largeIcon;
         wearConfig.highTemperature = highTemp;
         wearConfig.lowTemperature = lowTemp;
      }
      cursor.close();
      return wearConfig;
   }
    ...
    * need to construct the Strings needed for the wireframes. Fortunately parsing is easy:
...
//            Boolean.parseBoolean(context.getString(R.string.pref_enable_notifications_default)));
      ...
      if (true) {
         ...
         if (true){//System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            Uri weatherUri =
                  WeatherContract.WeatherEntry.buildWeatherLocationWithDate(locationQuery,
                        System.currentTimeMillis());
            ...
            if (cursor.moveToFirst()) {
               ...
               String contentText =
                     String.format(context.getString(R.string.format_notification), desc,
   ...
   private void sendWear(WearConfig wearConfig) {
      Asset asset = createAssetFromBitmap(wearConfig.icon);
      PutDataMapRequest request = PutDataMapRequest.create("/watch_face_config/Digital");
      request.getDataMap()
            .putAsset("weatherIcon", asset);
      request.getDataMap()
   ...
   private void updateWear() {
      mGoogleApiClient = new GoogleApiClient.Builder(getContext()).addConnectionCallbacks(
